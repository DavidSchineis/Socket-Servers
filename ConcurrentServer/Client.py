# Concurrent Socket Server, Multi-Threaded Client  
...
def main():
    ...
    while True:
        ...
        if operation == "goodbye_world":
            ...
            num_requests = int(input("\nEnter number of client requests to generate (1, 5, 10, 15, 20, 25, 100): "))

        if num_requests not in [1, 5, 10, 15, 20, 25, 100]:
